          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-end">
            ...
            <div className="relative lg:col-span-2">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl pl-9 pr-3 py-4 text-sm text-white placeholder:text-text-muted font-desc focus:outline-none focus:border-accent/50 focus:shadow-[0_0_12px_rgba(32,184,171,0.1)] transition-all"
              />
            </div>
            ...
            <select
              ...
              className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-4 text-sm text-white font-desc focus:outline-none focus:border-accent/50 transition-all appearance-none cursor-pointer"
            >
            ...
            <button
              type="submit"
              className="w-full bg-accent text-black font-elegant font-semibold text-sm py-4 px-6 rounded-xl hover:bg-accent-dark transition-all hover:shadow-[0_0_20px_rgba(32,184,171,0.25)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
            >
              Buscar
            </button>
          </div>
